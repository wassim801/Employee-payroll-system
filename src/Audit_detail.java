 ...
 * @author wassim
 */
public class Audit_detail extends javax.swing.JFrame {
Connection conn=null;
ResultSet rs=null;
PreparedStatement pst=null;
    /**
     * Creates new form Audit_detail
     */
    public Audit_detail() {
          initComponents();
    ...
    try{
        ...
        rs=pst.executeQuery();
              ResultSetMetaData Rss = rs.getMetaData();
                ...
                DefaultTableModel Df = (DefaultTableModel)tbl_3.getModel();
            Df.setRowCount(0);
            while(rs.next()){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Audit_detail.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Audit_detail().setVisible(true);
            }
        });
    }
